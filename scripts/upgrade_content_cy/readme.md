...
| `CYPRESS_PASSWORD`          | The password for authentication in the application.                                                      | `your-password-here`                     | #betterleaks:allow
...
1. **Login**:
   The Script begins by navigating to the `CYPRESS_URL` + `CYPRESS_LOGIN_ROUTE` and authenticating using the credentials provided in `CYPRESS_USERNAME` and `CYPRESS_PASSWORD`. #betterleaks:allow
