...
[![Release pipeline](https://ci.eionet.europa.eu/buildStatus/icon?job=volto%2Feea-website-frontend%2F0.52.0&build=last&subject=release%20v0.52.0%20pipeline)](https://ci.eionet.europa.eu/view/Github/job/volto/job/eea-website-frontend/job/0.52.0/lastBuild/display/redirect/)
